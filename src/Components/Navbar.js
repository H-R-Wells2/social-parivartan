...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center w-full bg-slate-600 p-2 text-white py-3 justify-between shadow-md shadow-slate-400 sticky top-0 z-50'>
            ...
            <div className='flex text-md sm:text-xl gap-1 sm:gap-4'>
                <div className='hidden sm:flex'>
                    ...
                    <FcSearch className='h-full w-7 rounded-r-lg bg-white hover:bg-slate-200 text-slate-800 cursor-pointer' />
                </div>

                <span className='font-normal flex items-center rounded-md hover:bg-slate-700/50 shadow-md sm:py-1 py-2 px-2 cursor-pointer sm:w-20 justify-center '><BsFillChatLeftTextFill className='pt-1 mr-1' /></span>
                <span className='font-normal flex items-center rounded-md hover:bg-slate-700/50 shadow-md py-1 px-2 cursor-pointer sm:w-20 justify-center'><IoMdNotifications className='' /></span>
